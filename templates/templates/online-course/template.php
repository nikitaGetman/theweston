...
<div id="online-course" class="popup_header_callback call-back__modal popup-small online-order">
	<div class="fancy">
		...
		<div class="fancy-inner">
			<h2 class="_H-h2-left js-hide">Запись на онлайн-обучение</h2>
			<div class="modal-order__visible">
				<span class="_primary-text-left modal-span__normal">Оставьте свои данные, и наш менеджер вам перезвонит</span>
